...
def insert2db(packet):
        ...
        ".format(args.dbtable, m_from, m_to, m_symbol_table, m_symbol, m_format, m_via, m_messagecapable, m_latitude, m_longitude, m_gpsfixstatus, m_posAmbiguity, m_altitude, m_speed, m_course, escape_string(m_comment), m_commentb64, escape_string(m_text), m_textb64, m_path, m_phg, m_rng, m_humidity, m_pressure, m_rain_1h, m_rain_24h, m_rain_since_midnight, m_temperature, m_wind_direction, m_wind_gust, m_wind_speed, m_addresse, escape_string(m_message_text), m_message_textb64, m_msgNo, m_response, m_bid, m_identifier, m_raw_timestamp, m_timestamp, m_seq, m_bits, m_analog1, m_analog2, m_analog3, m_analog4, m_analog5, m_bits, m_mtype, m_daodatumbyte, m_alive, escape_string(m_raw), m_rawb64)
...
def main():
        ...
        db = pymysql.connect(host=args.dbhost,
                user=args.dbuser,
